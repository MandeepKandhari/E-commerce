...
onPaymentSubmit=()=>{
	...
	render(){
		...
		<div className='w-100 flex justify-center'>
			<article className='w-50 ma4 pa3 flex flex-column justify-center items-center'  action="/action_page.php"  target="_self" method="post">
				<fieldset className='br4'>
					...
					<div className='w-100 pa3 flex flex-column justify-start'>
						...
						<div className='flex flex-wrap justify-center mt1 pa0'>
							<div className='flex flex-column ma1'>
								<label className='tl pl1' htmlFor='Expiry-date'>Expiry date</label>
								<input className='w-100-l w-80 br1 ba b--black pa2 ma1' 
								type='text' 
								name='Expiry-date'  
								placeholder='mm/yy'
							...
							<div className='flex flex-column ma1'>
								<label className='tl pl1' htmlFor='Security-code'>Security code</label>
								<input className='w-100-l w-80 br1 ba b--black pa2 ma1' 
								type='password' 
								name='Security-code' 
